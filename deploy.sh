...
# main config
PLUGINSLUG="easy-digital-downloads-software-specs" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="edd-software-specs.php" # this should be the name of your main php file in the wordpress plugin
